...
<div class="main-program black" id="housing">
  <div class="page__wrap">
    <div class="d-flex flex-wrap">
      ...
      <div class="bx">
        <div class="main-program_cart">
        <h2>نحن نقدم السكن بشروط تفضيلية:</h2>

        <div class="subinfo">
          سيتم بناء مجمع سكني للمشاركات في برنامج "ألابوغا ستارت" في خريف عام 2025.

          حتى الانتهاء من بناء المجمع السكني، ستعيش المشاركات في مساكن الطلبة.

        </div>
        <div class="block">
        <div class="ttl"> 
          تتوفر في مساكن الطلبة جميع المرافق اللازمة للإقامة.
        </div>
        <ul>
          <li>ثلاجة</li>
          <li>غرفة استحمام</li>
          <li>بياضات الأسرّة</li>
          <li>غسالات ملابس</li>
        </ul>
        </div>
